...
const baseDir = 'c:\\Projects\\AuraOS\\client\\src';

// Create directories
const dirs = ['services', 'hooks'];
dirs.forEach(dir => {
...
// Create services
const services = {
  'orderService.ts': `import { orderApi, getErrorMessage } from '../api'
...
// Write service files
Object.entries(services).forEach(([name, content]) => {
  const filePath = path.join(baseDir, 'services', name);
