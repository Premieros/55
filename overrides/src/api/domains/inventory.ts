...
export const inventory = {
  ...
  adjustRawStock(p: { p_raw_material_id: string; p_branch_id: string; p_warehouse_id: string; p_new_quantity: number; p_reason: string | null }): ApiResult<RpcResult> { return rpc('adjust_raw_stock', p); },
